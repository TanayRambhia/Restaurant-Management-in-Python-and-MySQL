...
payroll.resizable(10, 10)
payroll.title("Payroll Wages")
...
def MonthlySalary():
    ...
    MM_StudenLoan = "Rs", str('%.2f' % ((M_StudenLoan)))
    ...
    Deducat_Payment =  "Rs", str('%.2f' % ((Deduct)))
...
lblTitle = Label(Tops, font=('arial', 50, 'bold'), text="Payroll Wages", fg="Steel blue", bd=10, anchor="w")
...
lblStudenLoan = Label(InsideLFR, font=('arial', 12, 'bold'), text="Studen Loan", fg="Steel blue", bd=10, anchor="w")
...
lblNIPavment = Label(InsideLFR, font=('arial', 12, 'bold'), text="Insurance Pavment", fg="Steel blue", bd=10, anchor="w")
...
lblNINumber = Label(InsideRFL, font=('arial', 12, 'bold'), text="Insurance Number", fg="Steel blue", bd=10, anchor="w")
...
lblNICode = Label(InsideRFL, font=('arial', 12, 'bold'), text="Insurance Code", fg="Steel blue", bd=10, anchor="w")
